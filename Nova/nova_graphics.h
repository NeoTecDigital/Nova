...
private:
     ...
     *
     * Shared by both surface constructors - the SDL one in Nova/nova_sdl.cpp
     * and the external-VkSurfaceKHR one in Nova/nova_graphics.cpp - so the two
...
public:
     ...
     *
     * DEFINED IN Nova/nova_sdl.cpp, not in nova_graphics.cpp. That translation
