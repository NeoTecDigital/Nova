...
- **DMA-BUF client import** — Nova enables exactly one device extension today (`VK_KHR_SWAPCHAIN`, `core_base.cpp:247-249,:317-320`); needs the external-memory trio, modifier negotiation, per-plane import, cross-device fallback. D.2 builds most of this machinery — client import gets cheaper after Phase 3, another argument for the ordering.
